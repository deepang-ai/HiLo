...
base_dir = "path/to/ImageCAS/"
dataset_id = 30
dataset_name = f"Dataset{dataset_id:03}_ImageCAS"
...
for image_path, label_path in zip(image_paths, label_paths):
    ...
    for image_file in image_file_list:
        ...
        label_file_path = os.path.join(abs_label_path, image_prefix + label_suffix)
...
assert len(train_images) == 800
assert len(val_images) == 200
