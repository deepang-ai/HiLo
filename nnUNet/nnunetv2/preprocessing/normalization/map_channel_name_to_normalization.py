...
from nnunetv2.preprocessing.normalization.default_normalization_schemes import CTNormalization, NoNormalization, \
    ZScoreNormalization, RescaleTo01Normalization, RGBTo01Normalization, ImageNormalization, ImageCASNormalization, BASNormalization

channel_name_to_normalization_mapping = {
    'bas': BASNormalization,
    'imagecas': ImageCASNormalization,
    'ct': CTNormalization,
